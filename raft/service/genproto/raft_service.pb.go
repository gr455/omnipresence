...
func (x *VoteRequest) GetPeerId() int64 {
	if x != nil {
		return x.PeerId
	}
	return 0
...
var file_raft_service_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x03, 0x52, 0x04, 0x74, 0x65, 0x72, 0x6d, 0x32, 0xfa, 0x01, 0x0a, 0x0b, 0x52, 0x61,
	...
	0x74, 0x56, 0x6f, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2d, 0x0a,
	0x04, 0x56, 0x6f, 0x74, 0x65, 0x12, 0x11, 0x2e, 0x72, 0x61, 0x66, 0x74, 0x2e, 0x56, 0x6f, 0x74,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3c, 0x0a, 0x09, 0x41, 0x63, 0x6b, 0x41,
	0x70, 0x70, 0x65, 0x6e, 0x64, 0x12, 0x16, 0x2e, 0x72, 0x61, 0x66, 0x74, 0x2e, 0x41, 0x63, 0x6b,
	0x41, 0x70, 0x70, 0x65, 0x6e, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x17, 0x2e,
	0x72, 0x61, 0x66, 0x74, 0x2e, 0x41, 0x63, 0x6b, 0x41, 0x70, 0x70, 0x65, 0x6e, 0x64, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x2c, 0x5a, 0x2a, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x67, 0x72, 0x34, 0x35, 0x35, 0x2f, 0x6f, 0x6d, 0x6e, 0x69, 0x70,
	0x72, 0x65, 0x73, 0x65, 0x6e, 0x63, 0x65, 0x2f, 0x72, 0x61, 0x66, 0x74, 0x2f, 0x73, 0x65, 0x72,
...
var file_raft_service_proto_depIdxs = []int32{
	...
	4, // 1: raft.RaftService.RequestVote:input_type -> raft.RequestVoteRequest
	6, // 2: raft.RaftService.Vote:input_type -> raft.VoteRequest
	0, // 3: raft.RaftService.AppendEntries:input_type -> raft.AppendRequest
	2, // 4: raft.RaftService.AckAppend:input_type -> raft.AckAppendRequest
	5, // 5: raft.RaftService.RequestVote:output_type -> raft.RequestVoteResponse
	7, // 6: raft.RaftService.Vote:output_type -> raft.VoteResponse
	1, // 7: raft.RaftService.AppendEntries:output_type -> raft.AppendResponse
	3, // 8: raft.RaftService.AckAppend:output_type -> raft.AckAppendResponse
